  ...
  return (
    <div id='allinoneid' name='platforms' className='w-full my-32'>
      <div className='max-w-[1240px] mx-auto px-2'>
        <h2 className='text-5xl font-bold text-center'>All-In-One Health Solution</h2>
        ...
        <div className='grid sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-4'>
          ...
          <div className='flex'>
            ...
            <div>
              <h3 className='font-bold text-lg'>Bone and Joint</h3>
          ...
          <div className='flex'>
            ...
            <div>
              <h3 className='font-bold text-lg'>Cardiac</h3>
              <p className='text-lg pt-2 pb-4'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Asperiores maxime deserunt voluptatibus consequatur similique
                voluptates!
          ...
          <div className='flex'>
            ...
            <div>
              <h3 className='font-bold text-lg'>Child health</h3>
              <p className='text-lg pt-2 pb-4'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Asperiores maxime deserunt voluptatibus consequatur similique
                voluptates!
          ...
          <div className='flex'>
            ...
            <div>
              <h3 className='font-bold text-lg'>Covid 19</h3>
              <p className='text-lg pt-2 pb-4'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Asperiores maxime deserunt voluptatibus consequatur similique
                voluptates!
